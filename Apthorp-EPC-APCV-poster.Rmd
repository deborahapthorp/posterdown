...
```{r asrs-fig, echo = FALSE, fig.cap="ASRS part A (screening section) and subscales for diagnosed and non-diagnosed participants", out.width="100%", warning=FALSE}
...
par(mar=c(2,2,0,0))
#plot boxplots
(errors_commission_scatter | inattentiveness_scatter | dPrime_scatter)/(scanpath_scatter|fixation_count_scatter|fixation_duration_scatter)
